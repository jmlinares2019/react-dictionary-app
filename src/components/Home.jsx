        ...
        <div id="home" className="col-11 col-lg-12">
            <div className="row justify-content-center">
                <div className="col-lg-4">
                    <p>Welcome to my Wiktionary project! This app is built using React and uses the <a href="https://dictionaryapi.dev/" target="_blank">Free Dictionary API</a> for its results.</p>
